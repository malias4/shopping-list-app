...
describe("AddMemberAbl Tests", () => {
  describe("Happy Path (Positive Scenarios)", () => {
    // Test for successfully adding a member to a shopping list
    it("should add a member to a shopping list", async () => {
      // Insert test data
      ...
      expect(res.json).toHaveBeenCalledWith({
        status: "success",
        message: `User ${userId.toString()} added to shopping list 674b3f899ea7a953682fb779 successfully`,
