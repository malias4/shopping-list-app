...
describe("StatusItemAbl Tests", () => {
  describe("Happy Path (Positive Scenarios)", () => {
    // Test for successfully updating the status of an item in a shopping list
    it("should update the status of an item in a shopping list", async () => {
      // Insert test data
      ...
      const req = {
        body: { listId: "674b3f899ea7a953682fb779", itemId, isResolved: true },
      ...
      await StatusItemAbl(req, res);

      expect(res.json).toHaveBeenCalledWith({
        status: "success",
        message: `Item ${itemId} status updated to true in shopping list 674b3f899ea7a953682fb779`,
